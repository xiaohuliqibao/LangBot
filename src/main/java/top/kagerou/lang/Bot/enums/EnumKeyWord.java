...
public enum EnumKeyWord {
    ...
    GROUP_ADMIN(1, 700, "#"), GROUP_MENU(1, 701, "菜单"), GROUP_WEATHERS(1, 702, "天气"), GROUP_SCOLDME(1, 703, "-骂我"),
    GROUP_PRAISEME(1, 704, "-夸我"), GROUP_GAIVEMEONEHPICTURE(1, 705, "来张"), GROUP_NETYIYUN(1, 706, "网抑云"),
