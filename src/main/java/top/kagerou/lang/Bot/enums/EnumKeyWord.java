...
public enum EnumKeyWord {
    ...
    GROUP_ADMIN(1, 700, "#"), GROUP_MENU(1, 701, "菜单"), GROUP_MIRAIFEATURES(1, 702, "-Mirai功能"),
    GROUP_SCOLDME(1, 703, "-骂我"), GROUP_PRAISEME(1, 704, "-夸我"), GROUP_GAIVEMEONEHPICTURE(1, 705, "来张"),
    GROUP_NETYIYUN(1, 706, "网抑云"), GROUP_SONG(1, 706, "点歌"), GROUP_CUSTOMISEMESSAGE(1, 707, "有人发"),
    GROUP_DELCUSTOMISEMESSAGE(1, 708, "不再回复"), GROUP_DRIFTINGBOTTLE(1, 709, "-漂流瓶"), GROUP_VOICE(1, 710, "!语音"),
    GROUP_PCR(1, 711, "-PCR"), GROUP_QIERU(1, 712, "-切噜");
